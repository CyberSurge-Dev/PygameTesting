...
NOTE: 'dist' directory is for executables, they are not part of the project directly. 
To run this project, navigate to the dist/main folder, and double-click on main.exe
